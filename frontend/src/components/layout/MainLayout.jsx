...
const MainLayout = () => {
    return (
        <div className="min-h-screen flex justify-center bg-[#0a0a0a] selection:bg-primary-container selection:text-on-primary-container">
            <div id="app-root-frame" className="relative w-full max-w-[440px] transform bg-background shadow-2xl h-[100dvh] overflow-hidden flex flex-col font-body-md text-body-md text-on-background antialiased">
                <TopAppBar />
