        ...
        <div className="w-full">
          <table className="w-full text-left">
            <thead className="border-b border-[#2e2e2e]">
              <tr>
                <th className="px-6 py-3 text-xs font-semibold text-[#888888] uppercase">Event</th>
                <th className="px-6 py-3 text-xs font-semibold text-[#888888] uppercase text-center w-32">Email</th>
                <th className="px-6 py-3 text-xs font-semibold text-[#888888] uppercase text-center w-32">SMS</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#2e2e2e]">
              
              <tr>
                <td className="px-6 py-4 text-sm text-[#f5f5f5]">New Vendor Requests</td>
                <td className="px-6 py-4 text-center">
                  <input 
                    type="checkbox" 
                    checked={notifications.vendorRequests.email}
                    onChange={() => handleCheckboxChange('vendorRequests', 'email')}
                    className="w-4 h-4 rounded text-[#ff9f43] bg-transparent border-[#2e2e2e] focus:ring-[#ff9f43] cursor-pointer"
                  />
                </td>
                <td className="px-6 py-4 text-center">
                  <input 
                    type="checkbox" 
                    checked={notifications.vendorRequests.sms}
                    onChange={() => handleCheckboxChange('vendorRequests', 'sms')}
                    className="w-4 h-4 rounded text-[#ff9f43] bg-transparent border-[#2e2e2e] focus:ring-[#ff9f43] cursor-pointer"
                  />
                </td>
              </tr>
              ...
              <tr>
                <td className="px-6 py-4 text-sm text-[#f5f5f5]">Menu Updates</td>
                <td className="px-6 py-4 text-center">
                  <input 
                    type="checkbox" 
                    checked={notifications.menuUpdates.email}
                    onChange={() => handleCheckboxChange('menuUpdates', 'email')}
                    className="w-4 h-4 rounded text-[#ff9f43] bg-transparent border-[#2e2e2e] focus:ring-[#ff9f43] cursor-pointer"
                  />
                </td>
                <td className="px-6 py-4 text-center">
                  <input 
                    type="checkbox" 
                    checked={notifications.menuUpdates.sms}
                    onChange={() => handleCheckboxChange('menuUpdates', 'sms')}
                    className="w-4 h-4 rounded text-[#ff9f43] bg-transparent border-[#2e2e2e] focus:ring-[#ff9f43] cursor-pointer"
                  />
                </td>
              </tr>
              ...
              <tr>
                <td className="px-6 py-4 text-sm text-[#f5f5f5]">System Alerts</td>
                <td className="px-6 py-4 text-center">
                  <input 
                    type="checkbox" 
                    checked={notifications.systemAlerts.email}
                    onChange={() => handleCheckboxChange('systemAlerts', 'email')}
                    className="w-4 h-4 rounded text-[#ff9f43] bg-transparent border-[#2e2e2e] focus:ring-[#ff9f43] cursor-pointer"
                  />
                </td>
                <td className="px-6 py-4 text-center">
                  <input 
                    type="checkbox" 
                    checked={notifications.systemAlerts.sms}
                    onChange={() => handleCheckboxChange('systemAlerts', 'sms')}
                    className="w-4 h-4 rounded text-[#ff9f43] bg-transparent border-[#2e2e2e] focus:ring-[#ff9f43] cursor-pointer"
                  />
                </td>
              </tr>
